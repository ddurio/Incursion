...
void XboxController::UpdateInput() {
    ...
    // Update Triggers
    m_leftTrigger = RangeMapFloat( xboxControllerState.Gamepad.bLeftTrigger, 0, 255, 0, 1 );
    m_rightTrigger = RangeMapFloat( xboxControllerState.Gamepad.bRightTrigger, 0, 255, 0, 1 );
